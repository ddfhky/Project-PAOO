...
{
    private static Game instance=null;        /*!< Instanta singletonului*/
    ...
    private Object GameCamera;

    public PlayState level1_Part1, level1_Part2, level2_Part1,level2_Part2,level2_Part3;
    ...
    private void InitGame()
    {
       ...
       // playState       = new PlayState(refLink);
        ...
        level1_Part1    = new Level1_Part1(refLink);
        level1_Part2    = new Level1_Part2(refLink);
        level2_Part1    = new Level2_Part1(refLink);
        level2_Part2    = new Level2_Part2(refLink);
        level2_Part3    = new Level2_Part3(refLink);
    ...
    //design
    public synchronized static Game GetInstance(String title, int width, int height)
    {
        if(instance==null)
        {
