...
public class MenuState extends State
{
    ...
    public MenuState(RefLinks refLink)
    {
        ...
        background= ImageLoader.LoadImage("res/textures/menubackground.jpg");
        ...
        uiManager.addObject(new UIImageButton(288, 96, 128, 64, Assets.btn_start, new ClickListener() {
            @Override
            public void onClick() {
...
*/
        uiManager.addObject(new UIImageButton(288, 160, 128, 64, Assets.btn_exit, new ClickListener() {
            @Override
            public void onClick() {
                refLink.GetMouseManager().setUIManager(null);
                System.exit(0);
