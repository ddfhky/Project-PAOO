...
public abstract class Item
{
    ...
    protected boolean active=true; //cand setam active false, vom adauga cod in ItemManager ca sa stearga aceasta entitate
    ...
    public Item(RefLinks refLink, float x, float y, int width, int height)
    {
        ...
        normalBounds = new Rectangle(0, 0, width, height);
            ///Creaza dreptunghi de coliziune pentru modul de atack, aici a fost stabilit la
        // dimensiunea imaginii dar poate fi orice alta dimensiune
    ...
    /*! \fn public void SetNormalMode()
        \brief Seteaza modul normal dez interactiune
     */
